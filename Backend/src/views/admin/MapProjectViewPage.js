...
function MapProjectViewPage(props) {
  ...
  const tabList = ['ข้อมูลโครงการ', 'ข้อมูลแผนที่', 'สิทธิ์การเข้าถึง'];
            ...
            <div className="app-card-block">
              ...
              <div className="grids">
                <div className="grid lg-40 md-50 sm-100">
                  <span className="fw-700">ชื่อโครงการ :</span> {values.name}
                </div>
                <div className="grid lg-40 md-50 sm-100">
            ...
            <div className="app-card-block">
              <div className="table-wrapper">
                <table className="table">
                  <thead>
                    <tr>
                      <th style={{ minWidth: 140, width: '100%' }}>ผู้ใช้</th>
