          ...
          <form onSubmit={onLoadData}>
            <div className="grids">
              ...
              <div className="grid sm-50 md-30 lg-25 text-right xs-text-center">
                <Link to="/admin/map-data/create" className="btn btn-action btn-info">
            ...
            <table className="table" ref={tableRef}>
              <thead>
                <tr>
                  ...
                  <th style={{ minWidth: 180, width: '100%' }}>ชื่อข้อมูล</th>
                  <th style={{ minWidth: 280 }}>ข้อมูลที่อยู่</th>
                    ...
                    props.list.map((d, i) => (
                      <tr key={i}>
                        ...
                        <td className="ws-nowrap">
                          <Link to={`/admin/map-data/view/${d._id}`} className="h-color-p">
                            {d.name}
                          </Link>
                        </td>
                        <td className="ws-nowrap">
                        ...
                        <td className="text-center">
                          <Link to={`/admin/map-data/view/${d._id}`} className="table-option color-info">
                            <em className="fa-regular fa-eye"></em>
                          </Link>
                          <Link to={`/admin/map-data/update/${d._id}`} className="table-option color-success">
...
MapDatasPage.defaultProps = {
	
};
MapDatasPage.propTypes = {
